          ...
          <section id="left-box-1">
           ...
           <span class="flex lg:text-xl text-lg font-medium sm:font-medium gap-1 mb-4 text-[#0A609B]">
            ...
            <section id="purchaseButton" class="p-2 lg:p-3">
               <p class="text-gray-600 text-center pt-0">By clicking on 'Complete Order' below you agree to our <a href="#" class="underline font-bold text-black">Terms of Service</a> and <a href="#" class="underline text-black font-bold">Privacy Policy</a>.</p>
              <!-- <CustomButton v-if="formStore.formValues.paymentMethod !== 'PAYPAL' && !transactionStatus"
                ...
                buttonType="submit" /> -->
<CustomButton
  v-if="formStore.formValues.paymentMethod !== 'PAYPAL' && !transactionStatus"
  size="large"
  :color="false"
...
<img :src="'/images/1lock.png'" class="w-5 h-5" />
            ...
            <section id="gurantees" class="bg-gray-50">
              ...
              <div class="flex flex-wrap items-center gap-2 p-2 lg:p-3">
                ...
                <p class="text-sm">Our mission at Tactical X Abs is to empower you on your fitness journey without breaking the bank. We're so confident you will see incredible results that we offer a 30-day money-back guarantee, no questions asked.</p>
              </div>
              <Spacer />
            </section>
          </section>
...
<div class="p-2 sm:items-center sm:justify-between gap-3">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center gap-4">
    ...
    <!-- Email -->
    <a 
      href="mailto:help@tacticalabs.com"
      class="flex items-center gap-2 text-gray-700 hover:text-black transition"
    >
      <span class="w-7 h-7 flex items-center justify-center border rounded-full text-sm">
