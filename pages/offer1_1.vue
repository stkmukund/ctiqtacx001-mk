...
const upsell = async () => {
    const { productId, price, title } = await upsellProducts(config.offer1_1);
...
<template>
                    ...
                    <div
                        ...
                        <div class="md:text-left max-w-xl w-full md:w-1/2 px-4 text-center">
                            <h2 class="text-xl md:text-2xl font-bold mb-2">
                                Last Chance<br />with an Even Bigger Discount!
                            </h2>
                            <p class="text-gray-700 mb-4 text-base md:text-lg">
                                Protect your Tactical X Abs Stimulator for life with the <strong>ProtectPlus Lifetime Warranty at nearly 50% off for only $5.99!</strong>
                            </p>
                            <p class="text-gray-700 mb-4 text-base md:text-lg">
    ...
    <Alert message="" :pageTo="'/offer2'" :stepCompleted="3" />
</template>