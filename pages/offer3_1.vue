...
const upsell = async () => {
    const { productId, variants,title } = await upsellProducts(config.offer3_1);
    ...
    <section id="offer3" class="bg-white text-gray-800">
        ...
        <div class="container-fluid bg-gray-100">
            <div class="p-3 md:p-2 text-center max-w-4xl mx-auto">
                <h2 class="text-xs md:text-xs lg:text-base mb-1"><b>Last Chance with an Even Bigger Discount!</b> Get Our Revolutionary Fat Melting
...
</div>  <div class="max-w-4xl mx-auto ps-4">
                                ...
                                <div class="mt-0">
                                     <p class="font-medium mb-1 text-center text-gray-600">
                                        <span class="inline-block w-full border-t relative">
                                            <span
                                                class="text-nowrap text-sm absolute -top-3 bg-white px-2 left-1/2 -translate-x-1/2">   Select  <strong>Gender</strong>
                                            </span>
                                        </span>
                                    </p>
