...
<template>
    <section id="offer3" class="bg-white text-gray-800">
        ...
        <div class="container-fluid bg-gray-100">
            <div class="p-3 md:p-2 text-center max-w-4xl mx-auto">
                 <h2 class="text-xs md:text-xs lg:text-base mb-1"><b>Final Bonus Offer!</b> Get Our Revolutionary Fat Melting
                    Sauna Vest and AI Smart<br> Scale at <b>63% Off</b> for <b>Only $74.99 Today!</b>
                </h2>
        ...
        <div class="max-w-4xl mx-auto px-4">
            <!-- Comparison Section -->
            <div class="flex flex-col md:flex-row items-top justify-center p-2 md:p-1 pb-0">

                <!-- Image Container -->
                <div class="max-w-xl mb-2 mx-auto bg-gray-100 pr-4">
                    <NuxtImg :src="selectedImage" alt="Sauna Vest" class="mx-auto" />
        ...
        <div class="max-w-3xl mx-auto px-4">
                ...
                <p class="text-base mx-auto my-2 text-center max-w-2xl" style="line-height: 1.5;">Compliment your Tactical X Abs Stimulator with our best-selling Fat
                        Melting Sauna Vest and cutting edge AI Smart Scale. <br><br>Burn as much as 500 calories in
                        just 30 minutes of wearing our revolutionary vest, while our intelligent AI Smart Scale tracks your BMI, fat loss, muscle gain, and more!<br>
                        <br>
                        These products together have a combined value of $200, but for a limited-time we're giving you the perfect tools to jumpstart your fitness journey for only $74.99!
                    </p>
        ...
        <div class="max-w-4xl mx-auto text-center pt-1 px-5 pb-5 lg:hidden block">
            <h2 class="font-bold text-sm md:text-base mb-1">Tactical X Abs Customers Love Our Sauna Vest!</h2>
    ...
    <Alert message="" :pageTo="'/offer3_1'" :stepCompleted="6" />
</template>